...
void LivingroomTableSprite::Render(int x, int y, Vector2 topLeft)
{
	...
	std::cout << "||";
	Scene::GotoXY(44 + x + (CellX * x), 1 + y + (y * CellY), topLeft);
	std::cout << "||";
	Scene::GotoXY(44 + x + (CellX * x), 2 + y + (y * CellY), topLeft);
	std::cout << "||";
	Scene::GotoXY(44 + x + (CellX * x), 3 + y + (y * CellY), topLeft);
	std::cout << "||";
	Scene::GotoXY(44 + x + (CellX * x), 4 + y + (y * CellY), topLeft);
	std::cout << "||";
	Scene::GotoXY(44 + x + (CellX * x), 5 + y + (y * CellY), topLeft);
	std::cout << "||";
	/*Scene::GotoXY(0 + x + (CellX * x), 3 + y + (y * CellY), topLeft);
	std::cout << "|";
	Scene::GotoXY(0 + x + (CellX * x), 3 + y + (y * CellY), topLeft);
