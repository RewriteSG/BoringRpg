		...
		default:
			...
			case 0:
				if (!hasCalledTheCops)
				{
					...
					ui->PrintDialogue(Vector2(POINTX, POINTY), "Cops: Okay stay calm, help is on their way and will be there at 12:08.");
...
void InteractionsManager::Start(bool isGameStarted)
{
	...
	case 1:
		...
		ui->PrintDialogue(Vector2(POINTX, POINTY), "But I remember I needed to take a shower... let's do that first.");
		break;
	case 2:
