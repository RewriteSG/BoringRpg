...
void RobberDownSprite::Render(int x, int y, Vector2 topLeft)
{
	...
	Scene::GotoXY(3 + x + (CellX * x), 3 + y + (y * CellY), topLeft);
	Scene::ChangeColor(Scene::Purple);
	std::cout << "GG";
	...
	std::cout << "G";
	Scene::GotoXY(2 + x + (CellX * x), 1 + y + (y * CellY), topLeft);
	std::cout << "GGGG";
